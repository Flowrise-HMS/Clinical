...
enum EncounterPriority: string implements HasColor, HasDescription, HasLabel
{
    ...
    {
        return match ($this) {
            self::EMERGENCY => 'Immediately life-threatening, requires immediate attention',
            self::URGENT => 'Serious but not immediately life-threatening',
            self::ROUTINE => 'Standard priority for scheduled care',
            self::LOW => 'Can be scheduled when convenient',
        };
    }
