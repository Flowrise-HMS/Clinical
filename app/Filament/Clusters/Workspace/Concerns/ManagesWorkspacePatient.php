    ...
    protected function fillPatientFormDataFromCurrentPatient(): void
    {
        ...
        if (! method_exists($this, 'getSchema')) {
            ...
            $this->patientFormData = [
                'mrn' => $patient->mrn,
                'title' => enum_value($patient->title),
                ...
                'blood_type' => enum_value($patient->blood_type),
                'marital_status' => enum_value($patient->marital_status),
                'education_level' => enum_value($patient->education_level),
